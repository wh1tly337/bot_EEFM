...
btn4_director_emp = types.KeyboardButton('Добавить документы сотруднику')
btn5_director_emp = types.KeyboardButton('Обновить данные сотрудника')
btn6_director_emp = types.KeyboardButton('Отмена')
markup_director_emp.add(btn1_director_emp)
markup_director_emp.add(btn2_director_emp, btn3_director_emp)
markup_director_emp.add(btn4_director_emp,btn5_director_emp)
markup_director_emp.add(btn6_director_emp)
